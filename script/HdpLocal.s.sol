...
import {MockedSharpFactsRegistry} from "../src/FactsRegistry.sol";
...
contract HdpLocalDeployer is Script {
    function run() external {
        ...
        MockedSharpFactsRegistry factsRegistry = new MockedSharpFactsRegistry{salt: salt}();
        ...
        HdpExecutionStore hdpExecutionStore = new HdpExecutionStore{salt: salt}(iFactsRegistry, aggregatorsFactory, vm.envBytes32("HDP_PROGRAM_HASH"));
